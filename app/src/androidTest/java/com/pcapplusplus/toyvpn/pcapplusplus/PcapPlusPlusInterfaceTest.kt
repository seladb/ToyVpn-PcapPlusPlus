        ...
        fun getPacketAnalysisResults(): List<Array<Serializable>> {
            return listOf(
                ...
                arrayOf(
                    ...
                    Json.encodeToString(PacketData(isIPv4 = true, isUDP = true, connectionID = 3124694454L, isDNS = true, dnsQuery = "z163pic.v.bsgslb.cn", length = 65))
                ),
                arrayOf(
                ...
                arrayOf(
                    ...
                    Json.encodeToString(PacketData(isIPv4 = true, isTCP = true, connectionID = 3766857573L, isTLS = true, tlsServerName = "addons.mozilla.org", length = 213))
                )
            )
        }
    }
